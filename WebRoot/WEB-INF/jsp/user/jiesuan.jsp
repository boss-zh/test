...
.logo .div1 b {
	...
	top:-8;
	right: 0;
	background: url(img/images2/jiesuanye.png) #fff no-repeat;
	float: left;
}
.logo .div1 {
	width: 270px;
...
.step .s-num {
    ...
    width: 23px;
    height: 23px;
    background: url(img/images2/step.png) no-repeat;
    line-height: 23px;
}
...
.man_nameandadr_1_1 b{
    ...
    height: 12px;
    overflow: hidden;
    background: url(img/images2/name-right.png) no-repeat;
}
.man_nameandadr_1_2 {
	float: left;
	height: 30px;
...
.tuijian_1_1 i {
	...
	*zoom: 1;
	...
	background: url(img/images2/tuijian.png) 0 0 no-repeat #fff;
}
...
#pay-more b {
    ...
    width: 9px;
    margin-left: 5px;
    background: url(img/images2/pay-i.png) no-repeat 0 0;
}
...
.price-desc {
    ...
    vertical-align: middle;
    height: 20px;
    background: url(img/images2/tanhao.png) 4px 0 no-repeat;
    line-height: 20px;
    margin-right: 27px;
    color: #005ea7;
    padding-left: 29px;
...
.shopping-list {
    ...
    float: left;
    width: 100%;
    background: url(img/images2/shopping-list-bg.jpg) 0 0 repeat-y;
    margin-bottom: 10px;
}
...
.p-icon {
    ...
    *zoom: 1;
    ...
    margin: 0 5px 0 0;
    overflow: hidden;
    background: url(img/images2/purchase-icon.png) no-repeat;
    vertical-align: middle;
}
.ftx-04, .ftx04 {
    color: #ff6c00;
...
.step-toggle-on i {
    ...
    height: 8px;
    cursor: pointer;
    background: url(img/images2/arrow-up.png);
}
...
.freight-icon {
    ...
    *zoom: 1;
    ...
    height: 16px;
    vertical-align: middle;
    background: url(img/images2/freight-icon.png) center center no-repeat;
}
...
.tjbtn b {
    ...
    width: 135px;
    height: 36px;
    background: url(img/images2/btn-submit.jpg) no-repeat;
    cursor: pointer;
    overflow: hidden;
}
  ...
  <body>
        ...
        %>
    		...
    		<!--<div style="height: 30px;background-color: #F1F1F1;">
    			...
    			<div class="spacer"></div>
    			<div class="div-top2"style="width: 68px; padding: 0px 2px;"><a href="#">我的订单</a></div>
    			<div class="spacer"></div>
    			<div class="user" style="width: 123px;text-align: left;margin-right: 10px;"><a href="//home.jd.com" target="_blank">你好</a>&nbsp;&nbsp;
    			<a>退出</a></div>
    		</div>-->
    		<!--在此处定义一个锚点-->
    		<a name="top"></a>
			...
			<div class="w">
				...
				<ul class="fr">
					<li class="fore1" id="ttbar-login">
						<a href="" class="link-login style-red">你好,<%=user.getNickname()%></a>&nbsp;&nbsp;
		...
		<!--最顶上的一条结束-->
    		...
    		<!-- 京东图标 -->
    		<div class="logo">
    			<div class="div1"><a href="//www.jd.com/" class="link1"><img src="img/images2/jd.png" alt="京东商城"/></a>
    			<a href="#none" class="link2"><b></b>购物车</a></div>	
    			<div class="step" id="#logo-step">
			        <dl class="first done">
			            <dt class="s-num" style="background-image: (img/images2/step.png) #fff no-repeat;">1</dt>
    		...
    		<div class="checkout-steps" >
    			<div class="step-tit">
                        ...
                        <div class="extra-r" >
                            <a href="#none" class="ftx-05" style="position: relative;left:274px;">新增收货地址</a>
                        ...
                        <div class="man_nameandadr">
                        	<div class="man_nameandadr_1">
                        		<div class="man_nameandadr_1_1">
                        			<%=user.getNickname()%><b></b>
                        		</div>
                        		<!--地址-->
                        		<div class="man_nameandadr_1_2">
                        			<span id="nickName"><%=user.getNickname()%></span>
                        			<span id="address" title="<%=user.getAddress()%>" class="addr-info" limit="45"><%=user.getAddress()%></span>
                        			<span id="phoneNumber" class="addr-tel">132****1230</span>
                        		</div>
                        	</div>
                        </div>
                        <!--推荐匹配自提点-->
                        <div class="tuijian">
                        	...
                        	<div class="tuijian_1">
                        		...
                        		<div class="tuijian_1_2">
                        			<span title="大学城商业街茶语小站" class="addr-name">大学城商业街茶语小站</span><span title="山东省济南市长清区归德镇大学城商业街家家悦超市东门茶语小站" class="addr-info" limit="45">山东省济南市长清区归德镇大学城商业街家家悦超市东门茶语小站</span><span class="addr-tel"></span>
                        		</div>
                        	</div>
                        </div>
                       	...
                       	<div class="payment-list">
                       		<div class="list-cont">
                       			<ul>
                       				...
                       				<li>
                       					<div id="item-selected"><b></b>在线支付</div>
                       				</li>
                       				<li id="pay-more">
                       					<div id="paymore">更多<b></b></div>
                       				</li>
                       			</ul>
                       		</div>
                       	</div>
                    ...
                    <div class="goods">
                       	<div>
                       			<h3>送货清单</h3>
		                       	<div class="extra-r">
														  	<a class="price-desc" href="#none" ><i></i>&nbsp;价格说明</a>
														    <a href="ShoppingCartServlet?action=queryShoppingCart"  class="return-edit ftx-05" >返回修改购物车</a>
														</div>
                       	</div>
    				...
    				%>
												 ...
												 <!--单品开始-->
												      <div class="goods-items">     						
												        <div class="goods-item goods-item-extra" >
																		...
																		<div class="p-img">
																				<a target="_blank" href="http://item.jd.com/3141248.html"><img src="img/images2/pp1.jpg" style="width:80px;height:80px;"></a>
																		</div>
																		<div class="goods-msg">
																          <div class="goods-msg-gel">			
																		            ...
																		            <div class="p-price" style="position: relative;top:-11px;left: -1px;">
																		      			  <strong class="jd-price">￥<%=price%></strong>
																		              <span class="p-num">x<%=shoppingCarSum%></span>
                       			...
                       			<!--左侧-->
                    							...
                    							<div class="extral-r" style="float: right;">
                    								<a id="jd-goods-item" class="cor-goods" href="#none" style="padding-left: 29px;"><i></i>对应商品</a>
                    							</div>
                    							<div class="kuaidi">
                        						<span>京东快递<b></b></span>
                    							</div>
                    							<!--配送时间-->
                    							<div class="fore1" id="jd_shipment_calendar_date" style="margin-top: 20px;">
            ...
            <div class="step-tit">
            	...
            	<div id="part-inv" class="invoice-cont">
                  ...
                  <span class="mr10"> 明细  &nbsp; </span>   
                   <a href="#none" class="ftx-05 invoice-edit" >修改</a>
               </div>
            </div>
    	...
    	<div class="showMoney"style="margin-bottom: 10px;">
    		<div class="list">
    			<span><em class="ftx-01"><%=productTotalSum%></em> 件商品，总商品金额：</span>
    		<em class="price" id="warePriceId" >￥<%=productTotalPrice%></em>
    		</div>
    	...
    	<div class="tijiaodingdan">
          ...
          <span class="price-num" id="sumPayPriceId">￥<%=productTotalPrice%></span>
        </div>
        <div class="fc-consignee-info">
          <span class="mr20" id="sendAddr">寄送至：<%=user.getAddress()%></span>
          <span id="sendMobile">收货人：<%=user.getNickname()%>132****1230</span>
        </div>
    	</div>
    	 <div class="tijiao">
        	<!--
        	...
        	<button id="" value="提交订单" class="tjbtn"><a href="">提交订单</a><b></b></button>
        </div>
        	<!-- 右边悬浮 -->
				<div class="w">
