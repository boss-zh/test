	...
	<body>
		...
		<div class="top">
			<div class="center top2">
				<ul>
					...
					<li><a href="#">我的订单</a><div class="div_1"></div></li>
					<li><a href="#">jd_747e10435...</a><a>退出</a><div class="div_1"></div></li>
				</ul>
			</div>
		</div>
		<!--收银台-->
		...
		<div id="main" class="center">
			<div class="center">
				<div class="main-top">
				<div class="main-top1">
					<h3> 订单提交成功，请您尽快付款！&nbsp;订单号：${orderNo}</h3>
					<p>请您在提交订单后24小时内完成支付，否则订单会自动取消。</p>
				</div>
				
				<div id="top-right">
					<div class="main-top-right1">
						<em style="font-style: normal;">应付金额</em><strong>${orderTotalPrice}</strong><em>元</em>
					</div>
			...
			<div id="payment">
				...
				<div id="yinhangka">
					...
					<div class="p-count">
						...
						<div id="yhk-in">
						<i></i>
						<input type="text" name="" id="yhk-text" value="输入银行卡号或简码进行识别" />
						</div>	
					...
					<div id="zhifu">
						<input type="submit" id="sure" name="sure" value="立即支付" style="background-color: #b5b5b5;"/>
						<span >
							请选择银行支付
						</span>
					</div>
				...
				<div id="otherway">
					...
					<div class="otherway_div">
						...
						<a href="#">中国移动支付</a><span></span>
						<a href="#">中国银联</a><span></span>
						<a href="#">外籍内卡</a><span></span>
						<a href="#">预付卡支付</a><span></span>
						<a href="#">京东钱包扫一扫<i class="item-icon"></i></a><i class="item-tips">满减</i>
					</div>
				</div>
			</div>
