<%@ page language="java" import="java.util.*,com.vo.Product" pageEncoding="UTF-8"%>
<%
		...
		<div class="w">
			...
			<div id="settleup" class="dorpdown">
				<div class="cw-icon">
					...
					<a target="_blank" href="shoppingcar.html">我的购物车</a>
				</div>
		...
		<div class="p-item">
			<div class="p-img">
				<a href="//item.jd.com/1514838.html" target="_blank">
					<img src="img/images2/iphone8plus_addShoppingCartSuccess.jpg">
				</a>
			</div>
			<div class="p-info">
				<div class="p-name">
