<%@ page language="java" import="java.util.*,com.vo.*,com.page.PageInfo,com.service.impl.Category2ServiceImpl" pageEncoding="UTF-8"%>
<%
		...
		<div class="text-center categoryTableDiv">
			...
			<table id="productTable" class="table table-striped table-bordered table-hover">
				...
				<%
					...
					Category2 category = service.getCategoryById(String.valueOf(cid));
				 %>
